...
int main()
{
	...
	CrearCilindro(35, 1.0f);//índice 2 en MeshList
	...
	*/
	...
	glm::mat4 modelauxB(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía de la base
	glm::mat4 modelauxL(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía de las articulaciones y las llantas
	//MATRICES AUXILIARES PARA EL GATITO
	glm::mat4 modelauxP(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía de las patitas
	glm::mat4 modelauxC(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía de la cabeza
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// GATITO EJERCICIO 2
		/*
		//matriz de modelo con valor de la matriz identidad
		model = glm::mat4(1.0);
		...
		//Reiniciar la matriz hasta la traslacion del CUERPO
		model = modelaux;
		//CUELLO
		model = glm::translate(model, glm::vec3(-2.5f, 3.0f, 0.0f));
		modelauxC = model;
		...
		//para reiniciar la matriz a la posicion de la cabeza
		model = modelauxC;
		//BOCAAA
		...
		//Reiniciar la matriz hasta la traslacion del CUERPO
		model = modelaux;
		//ARTICULACION DE LA COLA
		model = glm::translate(model, glm::vec3(3.0f, 2.0f, 0.0f));
		//rotación alrededor de la articulación que une al cuerpo
		...
		//Reiniciar la matriz hasta la traslacion del CUERPO
		model = modelaux;
		//ARTICULACION DE LA PATA DELANTERA IZQUIERDA
		...
		//Reiniciar la matriz hasta la traslacion del CUERPO
		model = modelaux;
		//ARTICULACION DE LA PATA DELANTERA DERECHA
		model = glm::translate(model, glm::vec3(-1.5f, 0.0f, -2.0f));
		//rotación alrededor de la articulación 
		...
		//Reiniciar la matriz hasta la traslacion del CUERPO
		model = modelaux;
		//ARTICULACION DE LA PATA TRASERA IZQUIERDA
		model = glm::translate(model, glm::vec3(1.5f, 0.0f, 2.0f));
		//rotación alrededor de la articulación que une al cuerpo
		...
		//Reiniciar la matriz hasta la traslacion del CUERPO
		model = modelaux;
		//ARTICULACION DE LA PATA TRASERA DERECHA
		model = glm::translate(model, glm::vec3(1.5f, 0.0f, -2.0f));
		//rotación alrededor de la articulación 
		...
		*/
		...
		modelaux = model;
		modelauxB = model;
		model = glm::scale(model, glm::vec3(6.0f, 4.0f, 2.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//---------------------------------------------------------
		//CREACION DE LA ARTICULACIÓN LLANTA DELANTERA IZQUIERDA
		//SE REINICIA la matriz desde la traslacion de la base 
		model = modelauxB;
		model = glm::translate(model, glm::vec3(-3.0f, -1.5f, 3.0f));
		...
		//CREACION DE LLANTA DELANTERA IZQUIERDA
		model = modelauxL;
		...
		//---------------------------------------------------------
		//CREACION DE LA ARTICULACIÓN LLANTA TRASERA IZQUIERDA
		//SE REINICIA la matriz desde la traslacion de la base 
		model = modelauxB;
		model = glm::translate(model, glm::vec3(3.0f, -1.5f, 3.0f));
		//rotación de la articulación 
		...
		//CREACION DE LLANTA TRASERA IZQUIERDA
		model = modelauxL;
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.5f, 3.0f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//---------------------------------------------------------
		//CREACION DE LA ARTICULACIÓN LLANTA DELANTERA DERECHA
		//SE REINICIA la matriz desde la traslacion de la base 
		model = modelauxB;
		model = glm::translate(model, glm::vec3(-3.0f, -1.5f, -3.0f));
		//rotación de la articulación 
		...
		//CREACION DE LLANTA DELANTERA DERECHA
		model = modelauxL;
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.5f, 3.0f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//---------------------------------------------------------
		//CREACION DE LA ARTICULACIÓN LLANTA TRASERA DERECHA
		//SE REINICIA la matriz desde la traslacion de la base 
		model = modelauxB;
		model = glm::translate(model, glm::vec3(3.0f, -1.5f, -3.0f));
		//rotación de la articulación 
		...
		//CREACION DE LLANTA TRASERA DERECHA
		model = modelauxL;
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.5f, 3.0f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//SE REINICIA la matriz desde la traslacion de la CABINA 
		model = modelaux;
		//articulación 1
		model = glm::translate(model, glm::vec3(-1.0f, 0.0f, 0.0f));

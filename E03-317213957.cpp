...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//PRAMIDE CUADRANGULAR TECHO DE LA CASA
		model = glm::mat4(1.0);
		...
		//CUBO VENTANA 1 DE LA CASA
		model = glm::mat4(1.0);
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		model = glm::translate(model, glm::vec3(-0.27f, 0.37f, -2.44f));
		model = glm::scale(model, glm::vec3(0.4f, 0.4f, 0.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh();

		//CUBO VENTANA 2 DE LA CASA
		model = glm::mat4(1.0);
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		model = glm::translate(model, glm::vec3(0.27f, 0.37f, -2.44f));
		model = glm::scale(model, glm::vec3(0.4f, 0.4f, 0.1f));
		...
		//CUBO PUERTA DE LA CASA
		model = glm::mat4(1.0);
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		model = glm::translate(model, glm::vec3(0.0f, -0.5f, -2.44f));
		model = glm::scale(model, glm::vec3(0.4f, 0.4f, 0.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh();
		...
		//VENTANAS DERECHA
		//CUBO VENTANA 1 derecha DE LA CASA
		model = glm::mat4(1.0);
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		model = glm::translate(model, glm::vec3(0.57f, 0.37f, -3.27f));
		model = glm::scale(model, glm::vec3(0.1f, 0.4f, 0.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh();
		//CUBO VENTANA 2 derecha DE LA CASA
		model = glm::mat4(1.0);
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		model = glm::translate(model, glm::vec3(0.57f, 0.37f, -2.73f));
		model = glm::scale(model, glm::vec3(0.1f, 0.4f, 0.4f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[0]->RenderMesh();
		...
		//ESFERA VENTANA 3 TRASERA DE LA CASA
		model = glm::mat4(1.0);
		color = glm::vec3(0.0f, 0.0f, 1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -3.55f));
		model = glm::scale(model, glm::vec3(0.3f, 0.35f, 0.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		sp.render();
		...
		model = glm::translate(model, glm::vec3(1.2f, -0.575f, -3.0f));
		...
		model = glm::translate(model, glm::vec3(1.2f, -0.065f, -3.0f));
		model = glm::scale(model, glm::vec3(0.16f, 0.8f, 0.16f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
